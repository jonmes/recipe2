  ...
  <div
    ...
    <Form class="relative md:m-10 md:2-1/2 w-full bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4"
          ...
          <div class="w-1/4">
            <div class="relative mb-2">
              <div class="absolute flex align-center items-center align-middle content-center"
                ...
                <div class="w-0 py-1 rounded" style="width: 100%;"
                  :class="[process >= 2 ? 'bg-green-300' : 'bg-gray-300']"></div>
              </div>
              ...
              <div class="w-10 h-10 mx-auto rounded-full text-lg text-white flex items-center"
                ...
                <span class="text-center text-white w-full flex justify-center">
                  <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30"
                    xmlns:xlink="http://www.w3.org/1999/xlink" enable-background="new 0 0 314.862 314.862" width="30"
                    height="30">
                    <g>
                      <path
          ...
          <div class="w-1/4">
            <div class="relative mb-2">
              <div class="absolute flex align-center items-center align-middle content-center"
                style="width: calc(100% - 2.5rem - 1rem); top: 50%; transform: translate(-50%, -50%)">
                <div class="w-0 py-1 rounded" style="width: 100%;"
                  :class="[process >= 3 ? 'bg-green-300' : 'bg-gray-300']"></div>
              </div>

              <div class="w-10 h-10 mx-auto border-2 border-gray-200 rounded-full text-lg text-white flex items-center"
                :class="[process >= 3 ? 'bg-green-500' : 'bg-gray-300']">
                <span class="text-center text-green-600 w-full flex justify-center items-center">
                  <svg width="30px" height="30px" viewBox="0 0 30 30" id="icons" xmlns="http://www.w3.org/2000/svg">
                    <path
          ...
          <div class="w-1/4">
            <div class="relative mb-2">
              <div class="absolute flex align-center items-center align-middle content-center"
                style="width: calc(100% - 2.5rem - 1rem); top: 50%; transform: translate(-50%, -50%)">
                <div class="w-0 py-1 rounded" style="width: 100%;"
                  :class="[process === 4 ? 'bg-green-300' : 'bg-gray-300']"></div>
              </div>
          ...
          <!-- <div class="w-full mt-10 mb-10 items-center">
            ...
            <div v-for="(m, index) in values.ingredients" :key="index">
              <div class="w-full flex mb-10 items-center">
                ...
                <Field as="input" :name="`ingredients[${index}].name`" type="text"
                  class="shadow appearance-none border rounded w-3/12 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline ml-5"
                  rules="required" />
                ...
                <button
                  ...
                  type="button" @click="removeIng(index, values)">
                  <svg width="32" height="32" preserveAspectRatio="xMidYMid meet" viewBox="0 0 32 32"
                    style="transform: rotate(360deg)">
                    <path d="M12 12h2v12h-2z" fill="currentColor" />
                    <path d="M18 12h2v12h-2z" fill="currentColor" />
          ...
          <!-- <div class="w-full mt-10 mb-10 items-center">
            ...
            <div v-for="(step, index) in values.steps" :key="index">
              <div class="w-full flex mb-10 items-center">
                ...
                <button
                  class="uppercase ml-4 p-3 flex items-center border border-red-300 hover:border-red-600 text-red-500 hover:text-white hover:bg-red-600 max-w-max shadow-sm hover:shadow-lg rounded-full w-12 h-12"
                  type="button" @click="removeStep(index, values)">
                  <svg width="32" height="32" preserveAspectRatio="xMidYMid meet" viewBox="0 0 32 32"
                    style="transform: rotate(360deg)">
                    <path d="M12 12h2v12h-2z" fill="currentColor" />
                    <path d="M18 12h2v12h-2z" fill="currentColor" />
      ...
      <div class="form-group flex justify-between">
        <button v-if="process !== 1" type="button" class="text-white font-bold py-2 px-4 rounded-full"
          :class="isDisabled ? 'bg-red-300' : 'bg-red hover:bg-gradient-to-r from-red-400 to-green-500'"
          :disabled="isDisabled" @click="processor('-')">&#60; Back</button>
        <div></div>

        <button v-if="process < 4" type="button"
          class="bg-green hover:bg-gradient-to-r from-green-400 to-blue-500 text-white font-bold py-2 px-4 rounded-full"
          @click="processor('+')">Next</button>

        <p class="mr-52" v-if="isDisabled">
          <RotateSquare2 /> Loading . . .
        </p>

        <button v-if="process === 4" type="submit" class="text-white font-bold py-2 px-4 rounded-full"
