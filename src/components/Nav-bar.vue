<template>
    <div class="bg-gradient-to-r from-green-200 via-yellow-100 to-green-100 sticky top-0 z-20">
        <nav class="flex max-w-screen-xl justify-between items-center py-4 px-6 mx-auto md:px-12 lg:px-16 xl:px-24">
            <router-link :to="{ name: 'Home' }" class="text-3xl md:text-4xl font-bold tracking-wide slideUp">
                <span
            ...
            <div class="inset-0 transition-all bg-white/70 backdrop-blur-xl z-20 md:static md:bg-transparent md:flex items-center justify-center space-y-8 md:space-y-0 md:space-x-8 flex-col md:flex-row lg:space-x-14"
                ...
                <ul class="flex flex-col md:flex-row items-center space-y-6 md:space-y-0 md:space-x-6 lg:md:-x-8">
                    ...
                    <li class="text-lg md:text-base lg:text-lg font-medium group">
                        <router-link :to="{ name: 'Browse' }" @click="sidebarOpen = !sidebarOpen">Browse</router-link>
                        <div
                            class="h-0.5 bg-green scale-x-0 group-hover:scale-100 transition-transform origin-left rounded-full duration-300 ease-out" />
                    </li>
                    <li class="text-lg md:text-base lg:text-lg font-medium group">
                        ...
                        <div v-if="!$auth.loading.value">
                            ...
                            <div v-if="$auth.isAuthenticated.value">
                                <Popper arrow class="inline-block">
                                    ...
                                    <template #content="{}">
                                        <div class="menu">
                                            <h3 class="w-full flex justify-center items-center text-black text-md py-4">
                                                {{ name }}</h3>
                                            <ul class>
                                                <li class="list-none py-1 flex justify-start hover:text-black">
                                                    ...
                                                    <router-link :to="{ name: 'Profile' }">
                                                        <span class="pl-2 transition-all duration-500">Profile</span>
                                                    </router-link>
                                                </li>
                                                <li
                                                    ...
                                                    <router-link :to="{ name: 'Favorites' }">
                                                        <span class="pl-2 transition-all duration-500">Favorites</span>
                                                    </router-link>
                                                </li>
                                                <li
                                                    ...
                                                    <span class="pl-2 cursor-pointer transition-all duration-500"
