<template>
    <form @submit.prevent="sendFile" enctype="multipart/form-data" class="rounded-lg hover:shadow-xl bg-gray-50 mb-6">
        <div class="m-4">
            ...
            <div class="flex items-center justify-center w-full">
                <label
                    ...
                    :class="{ 'bg-green-100 border-green-400': is_dragover }" @drag.prevent.stop @dragstart.prevent.stop
                    @dragend.prevent.stop="is_dragover = false" @dragover.prevent.stop="is_dragover = true"
                    ...
                    <div class="flex flex-col items-center justify-center pt-7">
                        ...
                        <p class="pt-1 text-sm tracking-wider text-gray-400 group-hover:text-gray-600">Attach a Photo
                        </p>
                    </div>
                    <input multiple name="photos" class="hidden" type="file" accept="image/*"
        ...
        <div class="ml-10">
            <div v-for="(file, index) in filesHolder" :key="index" class="flex justify-between w-80 mb-4">
                ...
                <div>
                    <button @click.prevent="deleteImages(index)">
...
const deleteImages = (index) => {
    filesHolder.value.splice(index, 1)
    uploadFiles.value.splice(index, 1)
    toBeSent.value.splice(index, 1)
}
...
const sendFile = async () => {
    ...
    console.log(imgData.length, 'image data');
    if (imgData.length > 0) {
